...
wood_working = Folder.create(user_id: user1.id, name: 'Woodworking', emoji: '📁')
    online_class = Resource.create(name: "Online woodshop classes", emoji: "🔨", url: "www.thesprucecrafts.com/best-online-woodworking-classes-4847301")
    ...
    lathes = Resource.create(name: "5 Best Wood Lathes in 2021", emoji: "🪵", url: "www.thetoolsquare.com/best-wood-lathe/")
...
professional_dev = Folder.create(user_id: user1.id, name: 'Professional development', emoji: '📁')
    cm = Resource.create(name: "Classroom Management Lessons from Frank Kulle", emoji: "📚", url: "www.nais.org/magazine/independent-school/fall-2014/classroom-management-lessons-from-frank-kulle/")
    ...
    prompts_nest = FolderContent.create(folder_id: professional_dev.id, contentsable_id: prompts.id, contentsable_type: prompts.class.name)
        narrative_writing_prompts = Resource.create(name: "Narrative Writing Prompts", emoji: "✏️", url: "www.nytimes.com/2016/10/20/learning/lesson-plans/650-prompts-for-narrative-and-personal-writing.html")
    ...
    instruction_nest = FolderContent.create(folder_id: professional_dev.id, contentsable_id: instruction.id, contentsable_type: instruction.class.name)
        argument = Resource.create(name: "Strategies for Teaching Argumentation", emoji: "🗣️", url: "www.slideshare.net/JillPavich/strategies-for-teaching-argumentation-reasoning-tree")
        ...
        eqs = Resource.create(name: "What are Essential Questions?", emoji: "❓", url: "thesecondprinciple.com/essential-teaching-skills/essential-questions/")
...
guitar_tabs = Folder.create(user_id: user1.id, name: 'Guitar tabs', emoji: '📁')
    ...
    beatles_nest = FolderContent.create(folder_id: guitar_tabs.id, contentsable_id: beatles.id, contentsable_type: beatles.class.name)
        blackBird = Resource.create(name: "Blackbird", emoji: "🐦", url: "tabs.ultimate-guitar.com/tab/the_beatles/blackbird_tabs_180986")
        ...
        here = Resource.create(name: "Here Comes the Sun", emoji: "☀️", url: "tabs.ultimate-guitar.com/tab/the-beatles/here-comes-the-sun-tabs-201130")
    ...
    lumineers_nest = FolderContent.create(folder_id: guitar_tabs.id, contentsable_id: lumineers.id, contentsable_type: lumineers.class.name)
        left = Resource.create(name: "Left For Denver", emoji: "🚗", url: "tabs.ultimate-guitar.com/tab/the-lumineers/left-for-denver-chords-2797046")
        left_nest = FolderContent.create(folder_id: lumineers.id, contentsable_id: left.id, contentsable_type: left.class.name)
    r1 = Resource.create(name: "Between the Bars by Elliot Smith", emoji: "🎸", url: "tabs.ultimate-guitar.com/tab/elliott-smith/between-the-bars-chords-364836")
    r2 = Resource.create(name: "Kansas City by The New Basement Tapes", emoji: "🎸", url: "tabs.ultimate-guitar.com/tab/the_new_basement_tapes/kansas_city_chords_1678704")
